...
<a href="{{ url('prime') }}" id="navAction" class="mx-auto lg:mx-0 hover:underline bg-white text-black font-black rounded-full mt-4 lg:mt-0 py-4 px-8 shadow opacity-75 focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
  ...
  <div class="mt-20 -w-full container mx-auto flex flex-wrap items-center justify-between mt-0 px-2 py-3">
      ...
      <div class="flex items-center" id="store-nav-content">
            ...
            <nav id="store" class="w-full z-30 top-0 px-6 py-1">
                ...
                <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 px-2 py-3">
                    ...
                    <a class="mt-20  uppercase tracking-wide no-underline hover:no-underline font-bold text-white font-black text-xl " href="#">
				CRIMEN POLICÍACO
        <div class="w-full mb-4">
        <div class="h-1 mx-auto bg-white w-6/6 opacity-25 my-0 py-0 rounded-t"></div>
            ...
            <div class="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
                ...
                <svg class="h-6 w-6 fill-current text-white hover:text-black" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" onclick="alert('¡Pelicula Guardada en Favoritos!');sessionStorage.setItem('favoritos', fav('{{$pelicula->id}}'));">
