...
<section class="container mx-auto text-center py-6 mb-12">
      ...
      <h3 class="mt-20 my-4 text-3xl leading-tight">
       ¡Registrate gratis para visualizar películas!
      </h3>
      <button class="mx-auto lg:mx-0 hover:underline bg-white text-gray-800 font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out"onclick='window.location.replace("{{ route('register') }}");'>
        Registrate Ya!
      </button>
    </section>
     <!--Footer-->
...
<a href="{{ url('prime') }}" id="navAction" class="mx-auto lg:mx-0 hover:underline bg-white text-black font-black rounded-full mt-4 lg:mt-0 py-4 px-8 shadow opacity-75 focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
    ...
    <div class="pt-24">
      <div class="container px-3 mx-auto flex  flex-col md:flex-row items-start">
        <!--Left Col-->

       
     
        <div class="p-6 flex flex-col">
                    <img class="w-48 h-50 hover:grow hover:shadow-lg" src="{{asset($peliculas->imagen) }}">
                    
                    <div class="w-3/4 pt-3 flex flex-col items-start justify-between">
                        <div class="font-black"> <b class="text-gray-400">Película: </b> {{$peliculas->name}}</div><div class="font-black"><b class="text-gray-400">Director: </b> {{$peliculas->director}}</div><div class="font-black"><b class="text-gray-400">Año: </b> {{$peliculas->año}}</div><div class="font-black"><b class="text-gray-400">Género: </b> {{$peliculas->genero}}</div>
                        <div class="font-black "><b class="text-gray-400">Sinopsis:  </b>{{$peliculas->sinopsis}}</div>
                      
                    </div>

            </div>

            @if($peliculas->tipo=="Premium") 
           @if(Auth::user()->roles()->find(4)) 
  
        <div class="mr-20 mt-6 w-full md:w-3/5 pl-6 text-center ">
        <div class="aspect-w-16 aspect-h-9">
  <iframe id="prueba" src="" width="790" height="430" allow="fullscreen;"></iframe>
  ...
  <img src="{{ asset('sello.jpg') }}">
  <p class="text-red-500 text-lg font-bold">Registrate Premium para visualizar esta película</p>
  
   @endif
   @endif
   @if($peliculas->tipo=="Estandar")
   <div class="mr-20 mt-6 w-full md:w-3/5 pl-6 text-center ">
        <div class="aspect-w-16 aspect-h-9">
  <iframe id="prueba" src="" width="790" height="430" allow="fullscreen;"></iframe>
...
$(document).ready(function () {
    $.ajax({
        ...
        success: function (response) {
         $("#prueba").attr("src",response["{{$peliculas->id}}"-1].link);
        }
    });
});
