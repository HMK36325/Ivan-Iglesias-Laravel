    ...
    <div class="w-full flex flex-col h-screen overflow-y-hidden">
        ...
        <div class="w-full overflow-x-hidden border-t flex flex-col">
            <main class="w-full flex-grow p-6">
                <h1 class="text-3xl text-black font-bold pb-6">Administrar Suscripciones</h1>
...
@forelse($suscripciones as $sus)
 ...
 <tr>
 <td class="border px-4 py-2">{{$sus->name}}</td><!--necesita estar entre los corchetes para que lo pille(como en .jsp)-->
 <td class="border px-4 py-2">{{$sus->precio}}</td>
 
 <td class="border px-4 py-2">
    <a href="" class="text-blue-400">{{ __("Editar")}}</a> 
    <a href="#" class="text-red-400">{{ __("Eliminar")}}</a></td> 
    </td>
 </tr>
 ...
 <p><strong class="font-bold">{{ __("No hay suscripciones")}}</strong></p>
