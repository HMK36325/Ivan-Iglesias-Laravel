...
<div class="w-full h-screen overflow-x-hidden border-t flex flex-col">
            <main class="w-full flex-grow p-6">
                <h1 class="w-full text-3xl text-black pb-6">Formularios</h1>

                <div class="flex flex-wrap">
                    <div class="w-full lg:w-1/2 my-6 pr-0 lg:pr-2">
                        <p class="text-xl pb-6 flex items-center">
                            <i class="fas fa-list mr-3"></i> Form de Contacto
                        </p>
                        <div class="leading-loose">
                            <form class="p-10 bg-white rounded shadow-xl">
                                ...
                                <div class="mt-2">
                                    <label class=" block text-sm text-gray-600" for="message">Mensaje</label>
                    ...
                    <div class="w-full lg:w-1/2 mt-6 pl-0 lg:pl-2">
                        <p class="text-xl pb-6 flex items-center">
                            <i class="fas fa-list mr-3"></i> Formulario de Cliente
                        </p>
                        <div class="leading-loose">
                            <form class="p-10 bg-white rounded shadow-xl">
                                ...
                                <div class="mt-2">
                                    <label class="hidden text-sm block text-gray-600" for="cus_email">Ciudad</label>
                                ...
                                <p class="text-lg text-gray-800 font-medium py-4">Información de pago</p>
                                <div class="">
                                    <label class="block text-sm text-gray-600" for="cus_name">Tarjeta</label>
                                ...
                                <div class="mt-6">
                                    <button class="px-4 py-1 text-white font-light tracking-wider bg-gray-900 rounded" type="submit">Pagar</button>
                                </div>
                            </form>
                        </div>
