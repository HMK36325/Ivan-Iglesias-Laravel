...
<body class="bg-gray-100 font-family-karla flex">
    ...
    <aside class="relative gradient h-screen w-64 hidden sm:block shadow-xl">
        ...
        <nav class="text-white text-base font-semibold pt-3">
            <a href="{{route('admin.index')}}" class="flex items-center opacity-75 text-white py-4 pl-6 nav-item">
                <i class="fas fa-tachometer-alt mr-3"></i>
               Panel Principal
            </a>
            <a href="{{url('paginanueva')}}" class="flex items-center text-white active-nav-link hover:opacity-100 py-4 pl-6 nav-item">
    ...
    <div class="w-full flex flex-col h-screen overflow-y-hidden">
        ...
        <div class="w-full h-screen overflow-x-hidden border-t flex flex-col">
            <main class="w-full flex-grow p-6">
                <h1 class="text-3xl text-black pb-6">Nuevo Informe</h1>

                <!-- Content goes here! 😁 -->
            </main>
    
            <footer class="w-full bg-white text-right p-4">
                Built by <a target="_blank" href="https://davidgrzyb.com" class="underline">Oscar Ramal</a>.
            </footer>
        </div>
