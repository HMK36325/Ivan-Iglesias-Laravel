    ...
    <div class="w-full flex flex-col h-screen overflow-y-hidden">
        ...
        <div class="w-full overflow-x-hidden border-t flex flex-col">
            <main class="w-full flex-grow p-6">
                <h1 class="text-3xl text-black font-bold pb-6">Administrar Usuarios</h1>
...
<th class="px-4 py-2">{{ __("Actualizado")}}</th>
...
@forelse($users as $user)
 ...
 <tr>
 <td class="border px-4 py-2">{{$user->name}}</td><!--necesita estar entre los corchetes para que lo pille(como en .jsp)-->
 <td class="border px-4 py-2">{{$user->email}}</td>
 <td class="border px-4 py-2">{{$user->created_at}}</td>
 <td class="border px-4 py-2">{{$user->updated_at}}</td>
 <td class="border px-4 py-2">@foreach($user->roles as $role)
      {{$role->name."  "}}
      @endforeach</td>
 
 </td>
 <td class="border px-4 py-2">
    <a href="" class="text-blue-400">{{ __("Editar")}}</a> </td>
    <td class="border px-4 py-2"><a href="#" class="text-red-400">{{ __("Eliminar")}}</a></td> 
    </td>
 </tr>
